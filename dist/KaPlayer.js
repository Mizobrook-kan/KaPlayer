(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("KaPlayer", [], factory);
	else if(typeof exports === 'object')
		exports["KaPlayer"] = factory();
	else
		root["KaPlayer"] = factory();
})(window, function() {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(setImmediate) {/* harmony import */ var _finally__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _allSettled__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
...
var kaplayer_KaPlayer = /*#__PURE__*/function () {
  /**
   * @param {Object} object
   * @constructor
   */
  ...
  kaplayer_createClass(KaPlayer, [{
    ...
    value: function bindEvents() {
      ...
      this.audio.addEventListener('timeupdate', function (e) {
        ...
        _this.progress.style.width = "".concat(progressPercent, "%");
      }); // this.audio.addEventListener('ended', nextSong)

      this.audio.addEventListener('ended', function () {
        if (_this.list.index < _this.list.audios.length - 1) {
          _this.list["switch"]((_this.list.index + 1) % _this.list.audios.length);
...
//# sourceMappingURL=KaPlayer.js.map